...
public class KhoanChiRepository implements ICRUD<KhoanChi> {
    ...
    public KhoanChi get(int id) throws ParseException {
        ...
        query.moveToNext();
        return new KhoanChi(query.getInt(0), LoaiKhoanChi.valueOf(query.getString(4)), ICRUD.formatter.parse(query.getString(3)), query.getString(1), query.getDouble(2));
    }
    ...
    public List<KhoanChi> getAll() throws ParseException {
        ...
        while (query.moveToNext()){
           KhoanChi tmp =  new KhoanChi(query.getInt(0), LoaiKhoanChi.valueOf(query.getString(4)), ICRUD.formatter.parse(query.getString(3)), query.getString(1), query.getDouble(2));
            khoanChis.add(tmp);
        }
        return khoanChis;
    }
