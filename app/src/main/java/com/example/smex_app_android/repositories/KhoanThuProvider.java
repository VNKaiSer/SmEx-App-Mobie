...
public class KhoanThuProvider extends ContentProvider {

    private static final String PROVIDER_NAME = "com.example.smex.KhoanThuProvider";
    private static final String _PATH = "KhoanThu";
